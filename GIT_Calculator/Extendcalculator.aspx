<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Extendcalculator.aspx.vb" Inherits="GIT_Calculator.Extendcalculator" %>
...
<body>
    ...
    <div>
     <asp:Label ID="Label1" runat="server" Text="電卓税率8%"></asp:Label>
